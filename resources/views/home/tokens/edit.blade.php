                    ...
                    <div class="form-group form-group form__item{{ $errors->has('action') ? ' form__item--error' : '' }}">
                        ...
                        <div class="col-sm-8">
                            <select name="action" id="action" class="form-control">
                                <option value="deposit" @if ($token->action === 'deposit')  selected @endif >Пополнить
                                </option>
                                <option value="withdraw" @if ($token->action === 'withdraw') selected @endif >Списать
                                </option>
                                <option value="transfer" @if ($token->action === 'transfer') selected @endif >
                                    Перевести
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form__item{{ $errors->has('bookkeeping_id') ? ' form__item--error' : '' }}">
                            @foreach($bks as $bk)
                                <input type="radio" name="bookkeeping_id"
                                       value="{{ $bk->id }}" {{ ($bk->id == $token->bookkeeping_id) ? "checked" : "" }}>
                                &nbsp;{{ $bk->label }}
                                <br>
                            @endforeach
